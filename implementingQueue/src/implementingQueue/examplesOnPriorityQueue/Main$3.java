...
public class Main$3 {
	public static void main(String[] args) {
		Queue<Laptop> laptops=new PriorityQueue<>(Comparator.reverseOrder());
		 ...
		 */
		System.out.println("Total Laptops in Queue (MAX HEAP) : \n");
		...
		System.out.println("\nLaptop sorted on price (in reverse order): \n");
